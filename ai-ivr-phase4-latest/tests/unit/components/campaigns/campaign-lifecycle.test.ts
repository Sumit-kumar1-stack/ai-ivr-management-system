...
describe(
  ...
  () => {
    ...
    it(
      "hides the launch action when the campaign permission is missing",
      () => {
        const actions =
          getCampaignBoardActions(
            {
              id: "approved-no-launch-1",
              name: "Approved No Launch",
              description: null,
              prompt: null,
              knowledgeDocumentIds: [],
              audienceSourceId: null,
    ...
    it(
      "hides delete for a checker-owned draft campaign",
      () => {
        const actions =
          getCampaignBoardActions(
            {
    ...
    it(
      "hides archive for a checker-completed campaign",
      () => {
        const actions =
          getCampaignBoardActions(
            {
              id: "checker-completed-1",
              name: "Checker Completed",
              description: null,
              prompt: null,
              knowledgeDocumentIds: [],
              audienceSourceId: null,
    ...
    it(
      "shows archive for a maker-editable completed campaign",
      () => {
        const actions =
          getCampaignBoardActions(
            {
              id: "maker-completed-1",
              name: "Maker Completed",
              description: null,
              prompt: null,
              knowledgeDocumentIds: [],
              audienceSourceId: null,
